...
#This file is just 07.py but goes a step further and subtracts expenses to get net profit.
...
for i in range(12):
    monthyProfit[i] -= float(expenses[i]["Expenses"])
...
print(f"{maxMonth} had the most net profit with $ {maxRev:,.2f}.")
