...
#Same as 07.py, just find lowest instead of highest in the end
...
lowProfit = monthlyProfit[0]
lowestMonth = 0
months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']


for i in range(len(monthlyProfit)):
    if(monthlyProfit[i] < lowProfit):
        lowProfit = monthlyProfit[i]
        lowestMonth = months[i]


print(f"{lowestMonth} had the least gross profit with $ {lowProfit:,.2f}.")
