...
#Same as 06.py, just get the smallest instead of largest values at the end
...
leastMonth = 0
leastRev = 99999999999
for i in range(12):
    if(monthlyRevs[i] < leastRev):
        leastRev = monthlyRevs[i]
        mostProduct = months[i]

print(f"{mostProduct} had the least revenue with $ {leastRev:,.2f}.")
